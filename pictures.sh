...
# Скрипт pictures.sh размещаю в той же директории что и папки с операциями
...
# Запускаю 10-е окно: 10-png-pdf-png
# создаю окно "pic-10" в сессии Pictures
tmux new-window -n pic-10 -t Pictures

# Открываю в vim "png-pdf-png-сжать.sh"
tmux send-keys -t Pictures:10.1 'cd 10-png-pdf-png-сжать ; vim png-pdf-png-сжать.sh' C-m


# Запускаю 11-е окно: 11-pdf-to-jpg
# создаю окно "pic-11" в сессии Pictures
tmux new-window -n pic-11 -t Pictures

# Открываю в vim "png-to-jpg.sh"
tmux send-keys -t Pictures:11.1 'cd 11-pdf-to-jpg ; vim pdf-to-jpg.sh' C-m


# Запускаю 12-е окно: 12-jpg-сжать-фото
# создаю окно "pic-12" в сессии Pictures
tmux new-window -n pic-12 -t Pictures

# Открываю в vim "сжать_фото.sh"
tmux send-keys -t Pictures:12.1 'cd 12-jpg-сжать-фото ; vim сжать_фото.sh' C-m


# Запускаю 13-е окно: 13-jpg-добавить-поля
# создаю окно "pic-13" в сессии Pictures
tmux new-window -n pic-13 -t Pictures

# Открываю в vim "добавить-пустое-место-картинки.sh"
tmux send-keys -t Pictures:13.1 'cd 13-jpg-добавить-поля ; vim добавить-пустое-место-картинки.sh' C-m
